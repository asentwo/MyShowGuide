...
//  
//  //save- works 
//  func saveFavoriteToBackendless(_ showToSave: TvShowInfo, rep: @escaping (_ entity : AnyObject?) -> (Void), err:((Fault!) -> Void)) {
//   
...
//                    
//                    response: { ( favorites : BackendlessCollection!) -> Void in
//                      
...
//
//  //retrieve - works
//  func retrieveFavoriteFromBackendless(_ rep: @escaping ((BackendlessCollection!) -> Void), err: ((Fault!) -> Void) ) {
// 
