...
//    BackendlessUserFunctions.sharedInstance.backendlessUserRegister(emailTextField.text!,password: passwordTextField.text!,  rep: { ( user : BackendlessUser!) -> Void in
//      
...
//      )
//      
//      } as! ((BackendlessUser?) -> Void), err: { ( fault : Fault!) -> Void in
//        
